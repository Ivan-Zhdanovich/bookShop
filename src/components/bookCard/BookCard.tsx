...
export function BookCard({title, image, url, desc, authors, subtitle, price, isbn13} : IBookInfo) {
    ...
    const [isFav, setIsFav] = useState(favourites.includes(image))
    ...
    return (
        ...
        <div className={styles.card}>
            ...
            <div onClick={() => {<a href={url} target='_blank'></a>}}>
			<div className={styles.card}>
            ...
            {!isFav &&
             <button 
               className='py-2 px-3 bg-yellow-400 mr-2 rounded hover:shadow-md transition-all'
